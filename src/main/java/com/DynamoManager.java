...
public class DynamoManager {
    ...
    * */
    public void writeCandle(String symbol, String interval, Candlestick candlestick){
        /*
        ...
        */
        ...
        Item item = createCandleItem(candlestick);
    ...
    * */
    public void writeHistoricalCandles(String symbol, String interval, List<Candlestick> candlesticks){
        try {
            do {
                TableWriteItems tableWriteItems = new TableWriteItems(getCandleTableName(symbol,interval));
